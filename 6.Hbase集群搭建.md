...
总用量 278464
-rw-r--r--. 1 root root 285145442 8月  29 21:14 hbase-2.3.0-bin.tar.gz
[root@hadoop02 hbase]# 
[root@hadoop02 hbase]# tar -zxvf hbase-2.3.0-bin.tar.gz -C /usr/local/
[root@hadoop01 hbase]# cd /usr/local/hbase-2.3.0/conf/
